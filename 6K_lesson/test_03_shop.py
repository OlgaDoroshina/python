...
class internet_shop:
    ...
    def post(self):
        self._driver.find_element(By.CSS_SELECTOR, "#first-name").send_keys("Olga")
        self._driver.find_element(By.CSS_SELECTOR, "#last-name").send_keys("D")
        self._driver.find_element(By.CSS_SELECTOR, "#postal-code").send_keys("1111")
